...
export default function Cart() {
  ...
  return (
    <Box w={"1102.12px"} m={"auto"}>
      <Spacer h={"150px"} />
      <Heading>MY CART</Heading>
      <Grid templateColumns={"repeat(2, 1fr)"} mt={"50px"} gap={"20px"}>
        <GridItem w={"755px"} h={"130px"} borderRadius={"5px"}>
          {data.map((ele) => (
            <Flex
              bgColor={"#F8F7F5"}
              mb="20px"
            ...
            >
              <Flex w={"400px"} justifyContent={"space-between"}>
                <Img src={ele.image} w={"144px"} h={"108px"} />
                <Box>
                  <h1
                    fontWeight={"bold"}
                    fontSize={"16px"}
                  ...
                  <Text fontSize={"12px"} w={"200px"} mt={"5px"}>
                    {ele.detail}
                  </Text>
                  <Text
                    mt={"50px"}
        ...
        >
          <Box w={"300px"} m={"auto"}>
            <Flex mt={"30px"} justifyContent={"space-between"} width={"80px"}>
              <Heading fontSize={"24px"}>2</Heading>
